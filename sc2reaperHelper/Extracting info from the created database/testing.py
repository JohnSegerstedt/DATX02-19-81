...
parseFlag = 2 # 0 = all data, 1 = cluster data, 2 = training data
...
def extractFrameState(frameId, replayIds):
	...
	if parseFlag == 2:
		#add columns
		df_p1 = df_p1.reindex_axis(allColumnsVisionP1, 'columns')
		#fill empty with 0
		df_p1 = df_p1.fillna(0)
		#sort
		df_p1 = df_p1.reindex(sorted(df_p1.columns), axis=1)

		df_p2 = df_p2.reindex_axis(allColumnsVisionP2, 'columns')
